...
@section('contenido')
	<div class="row py-4 rounded" style="background-color: rgb(0,0,0,0.6);">
		...
		<div class="col-md-9 align-self-start">
			<div class="row">
				<div class="col-md-4">
					<a href="{{route('admin.usuario')}}" class="card text-white" style="background-color: rgb(0,0,0,0.4); border: 1px solid rgba(0, 72, 131, 0.5);">
				...
				<div class="col-md-4">
					<a href="{{route('animes.admin')}}" class="card text-white" style="background-color: rgb(0,0,0,0.4); border: 1px solid rgba(0, 72, 131, 0.5);">
						<div class="card-header text-center" style="background-color: rgb(0,0,0,0.7);">
							Anime
						</div>
						<div class="card-body text-center">
				...
				<div class="col-md-4">
					<a href="#" class="card text-white" style="background-color: rgb(0,0,0,0.4); border: 1px solid rgba(0, 72, 131, 0.5);">
						<div class="card-header text-center" style="background-color: rgb(0,0,0,0.7);">
							Manga
						</div>
						<div class="card-body text-center">
							<i class="fas fa-book-open fa-7x mx-auto d-block"></i>
						</div>
					</a>
				</div>
			</div>
